...
history = model.fit_generator(generator(df,datafolder_path="./data/data",augument=True,opname="train"),samples_per_epoch = 500*batch_size,nb_epoch=15,validation_data=generator(df_valid,datafolder_path="./data/data",augument=False,opname="valid"),nb_val_samples=4*batch_size)
